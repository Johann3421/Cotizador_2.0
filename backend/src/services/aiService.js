...
async function extractScannedWithOpenAI(pages) {
  ...
  const extractionPrompt = [
    ...
    '   → Número de modelo (copia los dígitos carácter por carácter, p.ej. si el texto dice "I7- 14700" escribe "14700"; si dice "I5- 11400" escribe "11400"):',
    '',
    ...
    'Antes de generar el JSON, completa esta tabla (responde cada ítem):',
    ...
    '     ANTI-SUSTITUCIÓN ABSOLUTA: el número 14700 ≠ 11700 ≠ 11400. Cópialo sin cambiar ni un dígito.',
    ...
    '',
    '  4. Campo NO encontrado en PASO 1 → null en el JSON. NUNCA inventes ni rellenes con valores típicos.',
